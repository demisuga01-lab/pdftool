...
export const metadata: Metadata = buildPageMetadata({
  title: "About PDFTools by WellFriend",
  description:
    "Learn what PDFTools by WellFriend offers, how the workspace is built, and where to reach the team.",
  path: "/about",
});
        ...
        <div className="space-y-8">
          ...
          <section className="tool-panel space-y-4">
            ...
            <div className="space-y-4 text-[15px] leading-8 text-slate-600 dark:text-zinc-300">
              ...
              <p>We believe file processing should be straightforward, trustworthy, and easy to access.</p>
