...
export default function ImageCropPage() {
  ...
  return (
    <ImageWorkspace
      ...
      centerContent={
        preview ? (
          <div className="mx-auto max-w-6xl rounded-2xl border border-zinc-200 bg-white p-4 dark:border-white/10 dark:bg-zinc-900 sm:p-6">
            <div className="flex min-h-[320px] items-center justify-center rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-white/10 dark:bg-zinc-950 sm:min-h-[520px] sm:p-6">
              <div className="relative inline-block max-w-full" ref={frameRef}>
                <img
                  alt={file?.name ?? "Preview"}
                  className="max-h-[65vh] max-w-full rounded-xl border border-zinc-200 bg-white object-contain dark:border-white/10"
                  src={preview.dataUrl}
                />
                <div className="absolute inset-0">
                  ...
                  <div
                    className="absolute border-2 border-[#059669] bg-transparent shadow-[0_0_0_9999px_rgba(0,0,0,0)]"
                  ...
                  >
                    {[
                      ...
                      <div
                        className={`absolute h-4 w-4 rounded-[2px] border-2 border-[#059669] bg-white dark:bg-zinc-900 md:h-[10px] md:w-[10px] ${className}`}
                        key={handle}
                        onPointerDown={(event) => {
