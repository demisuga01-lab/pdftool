    ...
    <CompactWorkspaceShell
      ...
      settingsPanel={
        <div className="space-y-6">
          <div className="rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] px-4 py-3 text-[13px] leading-6 text-slate-500 dark:border-white/10 dark:bg-slate-900 dark:text-slate-300">
          ...
          {result ? (
            <>
              <div className="space-y-3">
                ...
                <div className="rounded-xl border border-[#E5E7EB] bg-white dark:border-white/10 dark:bg-slate-900">
                  {[
                    ["Filename", file?.name ?? "--"],
                    ...
                    <div className="flex items-center justify-between gap-4 border-b border-[#E5E7EB] px-4 py-3 text-[13px] last:border-b-0 dark:border-white/10" key={label}>
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2">
                  ...
                  <Link
                    className="inline-flex h-9 items-center justify-center rounded-md border border-slate-200 bg-white px-3 text-[14px] text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-white/5"
                    href="/image/compress"
                  >
                    Strip all metadata
                  </Link>
