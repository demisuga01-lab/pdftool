      ...
      <div className="space-y-3">
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            return (
              <button
                className="flex h-10 items-center justify-center gap-1.5 rounded-lg border border-slate-200 text-[13px] font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white/5"
                key={option.label}
    ...
    <SingleImageWorkspacePage<RotateSettings>
      ...
      renderCenter={({ file, preview, settings, update }) => (
        <PreviewStage className="mx-auto max-w-[760px]">
          <div className="flex items-center justify-between gap-3 border-b border-zinc-200 px-4 py-3">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white/5"
              ...
              <button
                ...
                className={[
                  ...
                  settings.flipHorizontal ? "border-[#059669] bg-[#ECFDF5] text-[#059669] dark:border-emerald-400 dark:bg-emerald-500/10 dark:text-emerald-300" : "border-slate-200 hover:bg-slate-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white/5",
                ].join(" ")}
              ...
              <button
                ...
                className={[
                  "inline-flex h-9 w-9 items-center justify-center rounded-lg border text-slate-600",
                  settings.flipVertical ? "border-[#059669] bg-[#ECFDF5] text-[#059669] dark:border-emerald-400 dark:bg-emerald-500/10 dark:text-emerald-300" : "border-slate-200 hover:bg-slate-50 dark:border-white/10 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white/5",
                ].join(" ")}
          ...
          <div className="flex min-h-[min(55vh,420px)] items-center justify-center overflow-hidden bg-zinc-100 p-4 dark:bg-zinc-950">
            {preview ? (
              <img
                alt={file.name}
                className="max-h-[min(52vh,400px)] max-w-full rounded-lg border border-zinc-200 bg-white object-contain transition duration-150 dark:border-white/10"
                src={preview.dataUrl}
                style={{
