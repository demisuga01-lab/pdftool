...
export const metadata: Metadata = {
  ...
  title: {
    default: "PDFTools by WellFriend",
    template: "%s",
  },
  description:
    "PDFTools by WellFriend is a polished workspace for compressing, converting, merging, splitting, watermarking, OCR, and export.",
...
export default function RootLayout({
  ...
  return (
    <html className="h-full" lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} min-h-screen bg-zinc-50 text-zinc-900 antialiased dark:bg-zinc-950 dark:text-zinc-100`}>
        <ThemeProvider>
