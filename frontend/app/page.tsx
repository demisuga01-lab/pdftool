    ...
    <main className="bg-white dark:bg-slate-950">
      <section className="border-b border-slate-200 dark:border-white/10">
        <div className="mx-auto flex max-w-5xl flex-col items-center px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-24">
          ...
          <h1 className="mt-5 max-w-4xl text-[38px] font-bold leading-[1.05] text-[#111827] dark:text-slate-100 sm:text-[46px] lg:text-[52px]">
            Every PDF and Image tool you need
          </h1>
          <p className="mt-5 max-w-[560px] text-[18px] font-medium leading-8 text-slate-500 dark:text-slate-300">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-14">
          <div className="space-y-5" id="shared-tools">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <h2 className="text-[22px] font-semibold text-[#111827] dark:text-slate-100">Shared Tools</h2>
                <span className="rounded-full bg-[#EFF6FF] px-2.5 py-1 text-[12px] font-semibold text-[#2563EB] dark:bg-blue-500/10 dark:text-blue-300">
                  {sharedCount} tools
                </span>
              </div>
          ...
          <div className="space-y-5" id="pdf-tools">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <h2 className="text-[22px] font-semibold text-[#111827] dark:text-slate-100">PDF Tools</h2>
                <span className="rounded-full bg-[#EFF6FF] px-2.5 py-1 text-[12px] font-semibold text-[#2563EB] dark:bg-blue-500/10 dark:text-blue-300">
                  {pdfCount} tools
                </span>
              </div>
          ...
          <div className="space-y-5 border-t border-slate-200 pt-14 dark:border-white/10" id="image-tools">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <h2 className="text-[22px] font-semibold text-[#111827] dark:text-slate-100">Image Tools</h2>
                <span className="rounded-full bg-[#EFF6FF] px-2.5 py-1 text-[12px] font-semibold text-[#2563EB] dark:bg-blue-500/10 dark:text-blue-300">
                  {imageCount} tools
                </span>
              </div>
