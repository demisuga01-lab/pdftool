...
export function DocsPagination({
  ...
  return (
    <nav aria-label="Documentation pagination" className="grid gap-3 sm:grid-cols-2">
      {previous ? (
        <Link
          className="group rounded-[22px] border border-zinc-200/70 bg-white/82 p-5 shadow-sm backdrop-blur-xl transition hover:border-emerald-300/60 hover:bg-emerald-50/70 dark:border-white/10 dark:bg-zinc-900/78 dark:hover:border-emerald-400/30 dark:hover:bg-emerald-500/8"
          href={previous.href}
        >
      ...
      {next ? (
        <Link
          className="group rounded-[22px] border border-zinc-200/70 bg-white/82 p-5 text-left shadow-sm backdrop-blur-xl transition hover:border-emerald-300/60 hover:bg-emerald-50/70 dark:border-white/10 dark:bg-zinc-900/78 dark:hover:border-emerald-400/30 dark:hover:bg-emerald-500/8"
          href={next.href}
        >
