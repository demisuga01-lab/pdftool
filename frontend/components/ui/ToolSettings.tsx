  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-[#E5E7EB] bg-[#F9FAFB]">
        ...
        >
          <div>
            <p className="text-sm font-medium text-[#111827]">Advanced Settings</p>
            <p className="text-xs text-slate-500">Saved per tool on this device.</p>
          </div>
          <ChevronDown
            className={[
        ...
        {expanded ? (
          <div className="space-y-6 border-t border-[#E5E7EB] px-4 py-4">
            {sections.length > 0 || presets.length > 0 || customPresets.length > 0 ? (
              ...
              <div className="rounded-lg border border-[#E5E7EB] bg-white px-4 py-4 text-sm text-slate-500">
            ...
            {customPresets.length > 0 ? (
              <div className="space-y-2">
                <p className="text-xs font-medium text-slate-500">Saved presets</p>
                <div className="flex flex-wrap gap-2">
                  {customPresets.map((preset) => (
                    ...
                    {section.fields
                      ...
                      .map((field) => {
                        ...
                        if (field.type === "toggle") {
                          return (
                            <div className="flex items-center justify-between gap-4 rounded-lg border border-[#E5E7EB] bg-white px-4 py-3" key={field.key}>
                              <div className="space-y-1">
