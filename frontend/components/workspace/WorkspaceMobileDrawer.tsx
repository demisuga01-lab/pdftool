...
export function WorkspaceMobileDrawer({
  ...
  return (
    <>
      ...
      <div
        className={[
          "fixed inset-x-0 bottom-0 z-50 flex max-h-[85dvh] max-w-full flex-col overflow-hidden rounded-t-3xl border-t border-zinc-200/70 bg-white pb-[env(safe-area-inset-bottom)] shadow-[0_-24px_70px_rgba(15,23,42,0.16)] transition dark:border-white/10 dark:bg-zinc-900 dark:shadow-[0_-28px_80px_rgba(0,0,0,0.4)] lg:hidden",
      ...
      >
        ...
        {footer ? (
          <div
            className={[
              "shrink-0 border-t border-zinc-200/70 bg-white px-4 py-4 dark:border-white/10 dark:bg-zinc-900 sm:px-5",
              footerClassName ?? "",
            ].join(" ")}
            data-no-pan
            data-settings-control
